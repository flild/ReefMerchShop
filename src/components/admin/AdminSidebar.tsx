...
const navItems = [
  ...
  { href: '/admin/collects', label: 'Коллекты', icon: Boxes },
  { href: '/admin/users', label: 'Пользователи', icon: Users },
  { href: '/admin/content', label: 'Контент', icon: Settings },
];
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex items-center gap-3 px-5 py-4 rounded-full font-bold transition-all border-2",
                isActive 
