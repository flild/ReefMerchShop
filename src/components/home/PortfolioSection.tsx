...
export function PortfolioSection({ items }: PortfolioSectionProps) {
  ...
  return (
    <section className="py-24 bg-white border-t-4 border-slate-900 overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {items.map((item, index) => (
            <motion.div 
              ...
              className="group relative rounded-3xl overflow-hidden bg-white anime-border anime-shadow hover:-translate-y-2 hover:anime-shadow-hover transition-all duration-300 flex flex-col h-full cursor-pointer"
            >
              <div className="relative aspect-square overflow-hidden bg-slate-50 border-b-4 border-slate-900">
                <Image
              ...
              <div className="p-5 bg-white flex-1 flex flex-col">
                <h3 className="font-black text-lg text-slate-800 mb-1 line-clamp-2">{item.title}</h3>
